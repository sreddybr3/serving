...
DESCRIPTOR = _descriptor.FileDescriptor(
  ...
  syntax='proto3',
  serialized_pb=_b('\n0tensorflow_serving/apis/prediction_service.proto\x12\x12tensorflow.serving\x1a,tensorflow_serving/apis/classification.proto\x1a\x30tensorflow_serving/apis/get_model_metadata.proto\x1a\'tensorflow_serving/apis/inference.proto\x1a%tensorflow_serving/apis/predict.proto\x1a(tensorflow_serving/apis/regression.proto\x1a*tensorflow_serving/apis/model_config.proto2\xee\x04\n\x11PredictionService\x12\x61\n\x08\x43lassify\x12).tensorflow.serving.ClassificationRequest\x1a*.tensorflow.serving.ClassificationResponse\x12X\n\x07Regress\x12%.tensorflow.serving.RegressionRequest\x1a&.tensorflow.serving.RegressionResponse\x12R\n\x07Predict\x12\".tensorflow.serving.PredictRequest\x1a#.tensorflow.serving.PredictResponse\x12g\n\x0eMultiInference\x12).tensorflow.serving.MultiInferenceRequest\x1a*.tensorflow.serving.MultiInferenceResponse\x12m\n\x10GetModelMetadata\x12+.tensorflow.serving.GetModelMetadataRequest\x1a,.tensorflow.serving.GetModelMetadataResponse\x12p\n\x11UpdateModelConfig\x12,.tensorflow.serving.UpdateModelConfigRequest\x1a-.tensorflow.serving.UpdateModelConfigResponseB\x03\xf8\x01\x01\x62\x06proto3')
  ,
  dependencies=[tensorflow__serving_dot_apis_dot_classification__pb2.DESCRIPTOR,tensorflow__serving_dot_apis_dot_get__model__metadata__pb2.DESCRIPTOR,tensorflow__serving_dot_apis_dot_inference__pb2.DESCRIPTOR,tensorflow__serving_dot_apis_dot_predict__pb2.DESCRIPTOR,tensorflow__serving_dot_apis_dot_regression__pb2.DESCRIPTOR,tensorflow__serving_dot_apis_dot_model__config__pb2.DESCRIPTOR,])
...
_PREDICTIONSERVICE = _descriptor.ServiceDescriptor(
  ...
  _descriptor.MethodDescriptor(
    ...
    full_name='tensorflow.serving.PredictionService.UpdateModelConfig',
    index=5,
    containing_service=None,
    input_type=tensorflow__serving_dot_apis_dot_model__config__pb2._UPDATEMODELCONFIGREQUEST,
    output_type=tensorflow__serving_dot_apis_dot_model__config__pb2._UPDATEMODELCONFIGRESPONSE,
    options=None,
  ),
])
...
try:
  ...
  class BetaPredictionServiceStub(object):
    ...
    def UpdateModelConfig(self, request, timeout, metadata=None, with_call=False, protocol_options=None):
      """UpdateModelConfig - dynamically update the model config list
      """
      raise NotImplementedError()
    UpdateModelConfig.future = None
  ...
  def beta_create_PredictionService_server(servicer, pool=None, pool_size=None, default_timeout=None, maximum_timeout=None):
    ...
    request_deserializers = {
      ...
      ('tensorflow.serving.PredictionService', 'UpdateModelConfig'): tensorflow__serving_dot_apis_dot_model__config__pb2.UpdateModelConfigRequest.FromString,
    }
    response_serializers = {
      ...
      ('tensorflow.serving.PredictionService', 'UpdateModelConfig'): tensorflow__serving_dot_apis_dot_model__config__pb2.UpdateModelConfigResponse.SerializeToString,
    }
    method_implementations = {
      ...
      ('tensorflow.serving.PredictionService', 'UpdateModelConfig'): face_utilities.unary_unary_inline(servicer.UpdateModelConfig),
    }
  ...
  def beta_create_PredictionService_stub(channel, host=None, metadata_transformer=None, pool=None, pool_size=None):
    ...
    request_serializers = {
      ...
      ('tensorflow.serving.PredictionService', 'UpdateModelConfig'): tensorflow__serving_dot_apis_dot_model__config__pb2.UpdateModelConfigRequest.SerializeToString,
    }
    response_deserializers = {
      ...
      ('tensorflow.serving.PredictionService', 'UpdateModelConfig'): tensorflow__serving_dot_apis_dot_model__config__pb2.UpdateModelConfigResponse.FromString,
    }
    cardinalities = {
      ...
      'UpdateModelConfig': cardinality.Cardinality.UNARY_UNARY,
    }
